...
new_listing = np.array([2,1,1,2])
first_listing = normalized_listings.iloc[0][['accommodates', 'bathrooms']]
fifth_listing = normalized_listings.iloc[5][['accommodates', 'bathrooms']]
...
all_features_mse = mean_squared_error(test_df['price'], predictions)
