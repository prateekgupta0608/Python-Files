...
outer_text_items = parser.select(".outer-text")
first_outer_text = outer_text_items[0].text

id_second_items = parser.select("#second")
second_text = id_second_items[0].text
